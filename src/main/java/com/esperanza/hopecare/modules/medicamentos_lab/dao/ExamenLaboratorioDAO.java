...
public class ExamenLaboratorioDAO {
    ...
    public ExamenLaboratorio obtenerPorId(int idExamen, Connection conn) throws SQLException {
        String sql = "SELECT id_examen, nombre_examen, descripcion, precio, tiempo_resultado_horas, resultado_archivo FROM examen_laboratorio WHERE id_examen = ?";
    ...
    public List<ExamenLaboratorio> listarTodos() {
        ...
        String sql = "SELECT id_examen, nombre_examen, descripcion, precio, tiempo_resultado_horas, resultado_archivo FROM examen_laboratorio";
    ...
    public boolean insertar(ExamenLaboratorio examen, Connection conn) throws SQLException {
        String sql = "INSERT INTO examen_laboratorio (nombre_examen, descripcion, precio, tiempo_resultado_horas, resultado_archivo) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement ps = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            ps.setBytes(5, examen.getResultadoArchivo());
    ...
    private ExamenLaboratorio mapear(ResultSet rs) throws SQLException {
        ...
        e.setResultadoArchivo(rs.getBytes("resultado_archivo"));
        return e;
    }
}
