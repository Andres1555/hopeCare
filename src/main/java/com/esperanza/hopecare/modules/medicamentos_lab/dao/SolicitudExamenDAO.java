...
public class SolicitudExamenDAO {
    ...
    public SolicitudExamen obtenerPorId(int idSolicitud, Connection conn) throws SQLException {
        String sql = "SELECT id_solicitud, id_consulta, id_examen, fecha_solicitud, estado, resultado_texto, resultado_archivo, realizado_por, facturado FROM solicitud_examen WHERE id_solicitud = ?";
    ...
    public List<SolicitudExamen> listarPendientes() {
        ...
        String sql = "SELECT id_solicitud, id_consulta, id_examen, fecha_solicitud, estado, resultado_texto, resultado_archivo, realizado_por, facturado FROM solicitud_examen WHERE estado = 'PENDIENTE'";
    ...
    public List<SolicitudExamen> listarPorConsulta(int idConsulta) {
        List<SolicitudExamen> lista = new ArrayList<>();
        String sql = "SELECT id_solicitud, id_consulta, id_examen, fecha_solicitud, estado, resultado_texto, resultado_archivo, realizado_por, facturado FROM solicitud_examen WHERE id_consulta = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public boolean insertar(SolicitudExamen solicitud, Connection conn) throws SQLException {
        String sql = "INSERT INTO solicitud_examen (id_consulta, id_examen, estado, facturado) VALUES (?, ?, ?, ?)";
    ...
    public List<SolicitudExamen> listarPorEstado(String estado) {
        List<SolicitudExamen> lista = new ArrayList<>();
        String sql = "SELECT id_solicitud, id_consulta, id_examen, fecha_solicitud, estado, resultado_texto, resultado_archivo, realizado_por, facturado FROM solicitud_examen WHERE estado = ? ORDER BY fecha_solicitud DESC";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
